...
public class busBooking {
    ...
    public busBooking(String name, int age, int origin_Zone, int dest_Zone, int no_of_days){
        this.name = name;
        this.age = age;
 ...
 public void generateTicket(){
     ...
     System.out.println("*******New Wave Buses Prepaid Ticket*******");
     System.out.println("Passenger Name: " + getName());
     System.out.println("Ticket Valid For: " + getDays());
     System.out.println("Total Amount Paid: " + getAmount());
     System.out.println("Discount Received: " + getDiscount() + "%");
